...
def site_setting_palettes_list(site_id: int, limit: Limit = DEFAULT_LIMIT, offset: Offset = 0) -> str:
    resp = request("GET", f"/site-settings/{site_id}/palettes/", params={"limit": limit, "offset": offset})
