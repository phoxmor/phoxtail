"""``/api/pages/v1/page-types/`` — discovery endpoint.
...
from phoxtail.api.pages.v1._helpers import contribution_as_dict
from phoxtail.api.pages.v1.contrib import collect_page_schemas
from phoxtail.api.pages.v1.schemas import PageTypeCatalog
